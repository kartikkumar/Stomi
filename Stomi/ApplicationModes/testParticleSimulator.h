...
#ifndef STOMI_TEST_PARTICLE_SIMULATOR_H
#define STOMI_TEST_PARTICLE_SIMULATOR_H
...
/*!
 * Executes test particle simulator application mode.
...
#endif // STOMI_TEST_PARTICLE_SIMULATOR_H
