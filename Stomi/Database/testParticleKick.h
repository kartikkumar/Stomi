...
#ifndef STOMI_TEST_PARTICLE_KICK_H
#define STOMI_TEST_PARTICLE_KICK_H
...
//! Struct that contains kick data, generated by test particle simulations.
/*!
 * This struct contains data for one kick, stored in an SQLite3 database. The data stored
...
public:
    ...
    TestParticleKick( const int aTestParticleKickId,
...
#endif // STOMI_TEST_PARTICLE_KICK_H
